...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'django-insecure-bn6hrd9&g+qu8@kp+w$x20j02t&q70_x8-i*u4ji3=b4p-_r6@')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.getenv('DJANGO_DEBUG', 'True').lower() == 'true'

ALLOWED_HOSTS = ['*','binary-five-tan.vercel.app',]
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')],  # Add templates directory if required
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
